...
const uint8_t dcf77_analog_sample_pin = 17;
const uint8_t dcf77_sample_pin = 7; // A5
const uint8_t dcf77_inverted_samples = 1;
const uint8_t dcf77_analog_samples = 0;
 
const uint8_t dcf77_monitor_pin = 18;  // A4
 
const uint8_t lower_output_pin = 5;
const uint8_t upper_output_pin = 6;
 
const uint8_t dcf77_rolling_monitor_lower_pin = 4;
const uint8_t dcf77_rolling_monitor_upper_pin = 5;
